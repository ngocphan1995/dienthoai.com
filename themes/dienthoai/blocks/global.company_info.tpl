...
<ul class="company_info" itemscope itemtype="http://schema.org/LocalBusiness">
    ...
    <!-- BEGIN: company_address --><li style="margin-bottom: 12px"><a<!-- BEGIN: company_map_triger --> class="pointer" data-toggle="modal" data-target="#company-map-modal"<!-- END: company_map_triger -->><em class="fa fa-map-marker"></em><span><strong>{LANG.company_address}:</strong><br/> <span itemprop="address" itemscope itemtype="http://schema.org/PostalAddress"><span itemprop="addressLocality" id="company-address">{DATA.company_address}</span></span></span></a></li><!-- END: company_address -->
    <!-- BEGIN: company_phone --><li style="margin-bottom: 12px"><em class="fa fa-phone" style="position: relative;top: -8px;"></em><span><strong>{LANG.company_phone}:</strong><br/> <!-- BEGIN: item --><!-- BEGIN: comma -->&nbsp; <!-- END: comma --><!-- BEGIN: href --><a href="tel:{PHONE.href}"><!-- END: href --><span itemprop="telephone" style="margin-left: -24px;">{PHONE.number}</span><!-- BEGIN: href2 --></a><!-- END: href2 --><!-- END: item --></span></li><!-- END: company_phone -->
    ...
    <!-- BEGIN: company_email --><li style="margin-bottom: 12px"><em class="fa fa-envelope"style="position: relative;top: -9px;"></em><span><strong>{LANG.company_email}:</strong><br/> <!-- BEGIN: item --><!-- BEGIN: comma -->&nbsp; <!-- END: comma --><a href="mailto:{EMAIL}"><span itemprop="email" style="margin-left: -24px;">{EMAIL}</span></a><!-- END: item --></span></li><!-- END: company_email -->
    <li ><i class="fa fa-clock-o"></i> <strong style="
                                               margin-left: 16px;
                                               ">Working Days/Hours:</strong> <br/>
        Thứ 2 - Chủ nhật / 8:00 - 21:00 </li>
